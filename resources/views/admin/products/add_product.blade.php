...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>{{__('Home')}}</a> <a href="#">{{__('Products')}}</a> <a href="#" class="current">{{__('Add product')}}</a> </div>
    <h1>{{__('Products')}}</h1>
          ...
          <div class="widget-content nopadding">
            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{url('/admin/add-product')}}" name="add_product" id="add_product" novalidate="novalidate">
              ...
              <div class="form-actions">
                <input type="submit" name="image" id="image" value="Add Product" class="btn btn-success">
              </div>
            </form>
          </div>
        </div>
